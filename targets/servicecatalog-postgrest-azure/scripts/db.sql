...
-- 1 nazione
insert into in_geo
values (random_string(20), random_string(20), 'nazione', null);
-- 20 regioni
insert into in_geo
select random_string(20), random_string(20), 'regione', in_geo.id  
from generate_series(1, 20), in_geo
where in_geo.level = 'nazione';
-- 5 province per regione
insert into in_geo
select random_string(20), random_string(20), 'provincia', in_geo.id 
from generate_series(1, 5), in_geo 
where in_geo.level = 'regione';
-- 100 comuni per provincia
insert into in_geo
select random_string(20), random_string(20), 'comune', in_geo.id 
...
select random_string(20), random_string(20) from generate_series(1, 30000);
...
select random_string(20), random_string(20),
